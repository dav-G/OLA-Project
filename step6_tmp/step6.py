...
ucb1_long_label = "Stationary UCB1 (more phases)"
exp3_long_label = "EXP3 (more phases)"
swucb_w1_long_label = r"$SW\ UCB1,\ window\ size=\frac{1}{2}\ \sqrt{T}\ (more\ phases)$"
swucb_w2_long_label = r"$SW\ UCB1,\ window\ size=\sqrt{T}\ (more\ phases)$"
swucb_w3_long_label = r"$SW\ UCB1,\ window\ size=2 \sqrt{T}\ (more\ phases)$"
cducb_long_label = "CUSUM UCB1 (more phases)"
# %%
# Cumulative regret
...
axes[1].plot(np.cumsum(ucb1_long_regret), 'r', label=ucb1_long_label)
axes[1].plot(np.cumsum(exp3_long_regret), 'brown', label=exp3_long_label)
axes[1].plot(np.cumsum(swucb_w1_long_regret), 'b', label=swucb_w1_long_label)
axes[1].plot(np.cumsum(swucb_w2_long_regret), 'g', label=swucb_w2_long_label)
axes[1].plot(np.cumsum(swucb_w3_long_regret), 'y', label=swucb_w3_long_label)
axes[1].plot(np.cumsum(cducb_long_regret), 'm', label=cducb_long_label)
axes[1].legend(loc=0)
...
axes[1].set_xlabel('t')
axes[1].set_ylabel('Regret')
axes[1].plot(stducb_long, 'r', label=ucb1_long_label)
axes[1].plot(stdexp3_long, 'brown', label=exp3_long_label)
axes[1].plot(stdswucb_w1_long, 'b', label=swucb_w1_long_label)
axes[1].plot(stdswucb_w2_long, 'g', label=swucb_w2_long_label)
axes[1].plot(stdswucb_w3_long, 'y', label=swucb_w3_long_label)
axes[1].plot(stdcducb_long, 'm', label=cducb_long_label)
axes[1].legend(loc=0)
...
axes[1].plot(np.cumsum(np.mean(ucb1_long_rewards_per_experiment, axis=0)), 'r', label=ucb1_long_label)
axes[1].plot(np.cumsum(np.mean(exp3_long_rewards_per_experiment, axis=0)), 'brown', label=exp3_long_label)
axes[1].plot(np.cumsum(np.mean(swucb_w1_long_rewards_per_experiment, axis=0)), 'b', label=swucb_w1_long_label)
axes[1].plot(np.cumsum(np.mean(swucb_w2_long_rewards_per_experiment, axis=0)), 'g', label=swucb_w2_long_label)
axes[1].plot(np.cumsum(np.mean(swucb_w3_long_rewards_per_experiment, axis=0)), 'y', label=swucb_w3_long_label)
axes[1].plot(np.cumsum(np.mean(cducb_long_rewards_per_experiment, axis=0)), 'm', label=cducb_long_label)
axes[1].legend(loc=0)
...
axes[1].set_xlabel('t')
axes[1].set_ylabel('Regret')
axes[1].plot(np.cumsum(ucb1_long_instantaneous_regret), 'r', label=ucb1_long_label)
axes[1].plot(np.cumsum(exp3_long_instantaneous_regret), 'brown', label=exp3_long_label)
axes[1].plot(np.cumsum(swucb_w1_long_instantaneous_regret), 'b', label=swucb_w1_long_label)
axes[1].plot(np.cumsum(swucb_w2_long_instantaneous_regret), 'g', label=swucb_w2_long_label)
axes[1].plot(np.cumsum(swucb_w3_long_instantaneous_regret), 'y', label=swucb_w3_long_label)
axes[1].plot(np.cumsum(cducb_long_instantaneous_regret), 'm', label=cducb_long_label)
axes[1].legend(loc=0)
...
axes[1].set_xlabel('t')
axes[1].set_ylabel('Reward')
axes[1].plot(np.mean(ucb1_long_rewards_per_experiment, axis=0), 'r', label=ucb1_long_label)
axes[1].plot(np.mean(exp3_long_rewards_per_experiment, axis=0), 'brown', label=exp3_long_label)
axes[1].plot(np.mean(swucb_w1_long_rewards_per_experiment, axis=0), 'b', label=swucb_w1_long_label)
axes[1].plot(np.mean(swucb_w2_long_rewards_per_experiment, axis=0), 'g', label=swucb_w2_long_label)
axes[1].plot(np.mean(swucb_w3_long_rewards_per_experiment, axis=0), 'y', label=swucb_w3_long_label)
axes[1].plot(np.mean(cducb_long_rewards_per_experiment, axis=0), 'm', label=cducb_long_label)
