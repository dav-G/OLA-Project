...
for e in range(0, n_experiments):
    ...
    swucb_learner_w1 = SWUCB_Learner(n_arms, c1.prices,int(0.5 * T) ,margin, clicks, cost)
    swucb_learner_w2 = SWUCB_Learner(n_arms, c1.prices,int(2*sqrt(T)), margin, clicks, cost)
...
swucb_w2_label = r"$SW\ UCB1,\ window\ size=2\sqrt{T}$"
swucb_w3_label = r"$SW\ UCB1,\ window\ size=3\ \sqrt{T}$"
